...
None. The AC-2 and AC-5 controls are both hand-writable stubs — a plain derangement
generator and a constant generator — and neither needs the real implementation.
